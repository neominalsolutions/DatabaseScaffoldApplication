...
namespace DatabaseScaffoldApplication.Controllers
{
    public class CartController : Controller
    {
        ...
        public JsonResult AddToCart(CartItem cartItem)
        {
            ...
            HttpContext.Session.GetString("key1");
            HttpContext.Session.SetString("key1", "key");
            HttpContext.Session.SetInt32("key3", 1);
            HttpContext.Session.GetObject<UserResource>("resources");
